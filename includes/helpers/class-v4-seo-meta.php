...
/**
 * V4_Seo_Meta — SEO-plugin meta abstraction.
 *
...
final class V4_Seo_Meta {
    ...
    public static function write(int $post_id, string $title, string $description): array {
        $result = ['written' => false, 'source' => 'none', 'fields' => []];
    ...
    /**
     * Whether a string still contains SEO-plugin template tokens.
     *
